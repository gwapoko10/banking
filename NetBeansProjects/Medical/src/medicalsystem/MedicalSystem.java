    ...
    public static void main(String[] args) {
     ...
     char ans;
       ArrayList<MedicalSystem>  patientsrecord = new ArrayList<>();   
        ...
        System.out.print("\n\t\t\tEnter Option choosen: ");
        int options = sc.nextInt();
        
            while(options <1 || options >9){
     ...
     switch(options){
                ...
                case 3:
                    ...
                    int patientidfordiagnosis = 0;
                    boolean isExistingPatient = false;

                    
                    while (patientidfordiagnosis <= 0 || !isExistingPatient) {
                        ...
                        patientidfordiagnosis = sc.nextInt();
                        sc.nextLine(); 

                        if (patientidfordiagnosis <= 0) {
                            System.out.println("Invalid patient ID, Enter a positive ID: ");
                            continue; 
                        }
                        ...
                        if (!isExistingPatient) {
                            System.out.println("Patient ID does not exist. Please enter an existing ID: ");
                        }
                    }
